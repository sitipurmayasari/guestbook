<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div
        ...
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 class="font-semibold text-slate-800 dark:text-slate-100">DATA UNIT KERJA BPOM</h2>
        </header>
        <div class="p-3">
                ...
                <table class="table-auto w-full dark:text-slate-300">
                    ...
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="p-2">
                                <div class="font-semibold text-center">NAMA UNIT KERJA</div>
                            </th>
                    ...
                    <tbody class="text-sm font-medium divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        @forelse ($data as $key => $row)
                            <tr>
                                ...
                                <td class="p-2">
                                    <div class="text-left">{{ $row->nama_unit }}</div>
                                </td>
                                ...
                                <td class="p-2">
                                    <div class="text-right py-2">
                                        ...
                                        <button wire:click="confirmDelete('{{ $row->id }}','{{ $row->nama_unit }}')"
                                            type="button"
    ...
    @if ($isOpen)
    @include('livewire.master.modal-Unit')
@endif
