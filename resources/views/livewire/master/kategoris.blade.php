<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div
        ...
        <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 class="font-semibold text-slate-800 dark:text-slate-100">DATA KATEGORI</h2>
        </header>
        <div class="p-3">
                            ...
                            <tr>
                                ...
                                <td class="p-2">
                                    <div class="text-right py-2">
                                        ...
                                        <button wire:click="confirmDelete('{{ $row->id }}','{{ $row->nama }}')"
                                            type="button"
    ...
    @if ($isOpen)
    @include('livewire.master.modal-Kategori')
@endif
