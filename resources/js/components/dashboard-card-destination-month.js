...
import {
  ...
  const dashboardCardDestinationMonth = () => {
    const ctx = document.getElementById('dashboard-card-destination-month');
    if (!ctx) return;
    ...
    fetch('/json-data-chart?datatype=6')
      .then(a => {
        return a.json();
      })
      .then(result => {
        ...
        const chart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              // Light blue bars
              {
                label: 'Total Negara Tujuan dalam bulan',
                data: dataset1,
                // data: [
          ...
          options: {
            ...
            plugins: {
              ...
              htmlLegend: {
                ...
                containerID: 'dashboard-card-destination-month-legend',
              },
              tooltip: {
                callbacks: {
  ...
  export default dashboardCardDestinationMonth;
