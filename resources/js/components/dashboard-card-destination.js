...
import {
  ...
  const dashboardCardDestination = () => {
    const ctx = document.getElementById('dashboard-card-destination');
    if (!ctx) return;
    ...
    fetch('/json-data-chart?datatype=5')
      .then(a => {
        return a.json();
      })
      .then(result => {
        ...
        const chart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              // Light blue bars
              {
                label: 'Total Negara Tujuan dalam setahun',
                data: dataset1,
                // data: [
          ...
          options: {
            ...
            plugins: {
              ...
              htmlLegend: {
                ...
                containerID: 'dashboard-card-destination-legend',
              },
              tooltip: {
                callbacks: {
  ...
  export default dashboardCardDestination;
