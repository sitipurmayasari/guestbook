...
import {
  ...
  const dashboardCardCommodity = () => {
    const ctx = document.getElementById('dashboard-card-commodity');
    if (!ctx) return;
    ...
    fetch('/json-data-chart?datatype=7')
      .then(a => {
        return a.json();
      })
      .then(result => {
        ...
        const chart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              // Light blue bars
              {
                label: 'Total Komoditas dalam setahun',
                data: dataset1,
                // data: [
          ...
          options: {
            ...
            plugins: {
              ...
              htmlLegend: {
                ...
                containerID: 'dashboard-card-commodity-legend',
              },
              tooltip: {
                callbacks: {
  ...
  export default dashboardCardCommodity;
