...
const dashboardCardEksporDay = () => {
  const ctx = document.getElementById('dashboard-card-ekspor-day');
  if (!ctx) return;
  ...
  fetch('/json-data-chart?datatype=1')
    .then(a => {
      return a.json();
    })
    .then(result => {
      ...
      const chart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            // Light blue bars
            {
              label: 'Total Permohonan Ekspor (Bulan ini)',
              data: dataset1,
              // data: [
        ...
        options: {
          ...
          plugins: {
            ...
            htmlLegend: {
              ...
              containerID: 'dashboard-card-ekspor-day-legend',
            },
            tooltip: {
              callbacks: {
...
export default dashboardCardEksporDay;
