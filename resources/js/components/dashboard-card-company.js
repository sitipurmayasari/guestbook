...
import {
  ...
  const dashboardCardCompany = () => {
    const ctx = document.getElementById('dashboard-card-company');
    if (!ctx) return;
    ...
    fetch('/json-data-chart?datatype=9')
      .then(a => {
        return a.json();
      })
      .then(result => {
        ...
        const chart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              // Light blue bars
              {
                label: 'Total Perusahaan dalam setahun',
                data: dataset1,
                // data: [
          ...
          options: {
            ...
            plugins: {
              ...
              htmlLegend: {
                ...
                containerID: 'dashboard-card-company-legend',
              },
              tooltip: {
                callbacks: {
  ...
  export default dashboardCardCompany;
