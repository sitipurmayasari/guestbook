...
import {
  ...
  const dashboardCardCompanyMonth = () => {
    const ctx = document.getElementById('dashboard-card-company-month');
    if (!ctx) return;
    ...
    fetch('/json-data-chart?datatype=10')
      .then(a => {
        return a.json();
      })
      .then(result => {
        ...
        const chart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
              // Light blue bars
              {
                label: 'Total Perusahaan dalam bulan ini',
                data: dataset1,
                // data: [
          ...
          options: {
            ...
            plugins: {
              ...
              htmlLegend: {
                ...
                containerID: 'dashboard-card-company-month-legend',
              },
              tooltip: {
                callbacks: {
  ...
  export default dashboardCardCompanyMonth;
